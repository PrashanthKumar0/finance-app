...
function NavBar() {
  return (
    <nav className="z-10 relative sticky top-0 bg-black/70 shadow-xl shadow-black/50 backdrop-blur-md">
      <div className="max-w-screen-xl flex flex-wrap gap-4 items-center justify-between  p-4">
        ...
        <div
          ...
          id="navbar-user"
        >
          <ul className="flex flex-col md:p-0 mt-4 md:space-x-4 md:flex-row md:mt-0 md:border-0 bg-black dark:border-gray-700">
            <li>
              <a
                href="#"
